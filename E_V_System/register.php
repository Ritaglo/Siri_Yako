				...
				<div class="col-md-7 middle-area"> 
					<div class="content"> 
						...
						<div class="col-sm-offset-2 success_hide" id="success">
							<h4> >> Successfully Registered! <br> >> You can now login to vote <a rel="facebox" href="voting.php">Here</a>.</h4>					
						</div>
						...
						<div class="col-sm-6">
						  <input type="number" name="nid" size="8" class="form-control" id="inputEmail3" placeholder="National ID " pattern="[0-9]{8}"  required>
						</div>
						</div>
						<div class="form-group">
