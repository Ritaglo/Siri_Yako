						...
						<div class="commission">
							...
							<div class="lists">
								<ul class="text-capitalize ">
									...
									<li class="current" ><a href="laws.php" class="current">laws and procedures</a></li>
				...
				<div class="col-md-7 middle-area"> 
					<div class="content"> 
						<div class="laws-area">
							...
							<p>Our Country Election Commission is based on the parliament  which is structured as follows:</p>
							<ul>
								<li>An elected president</li>
								<li>An elected governer</li>
								<li>Elected Senator</li>
								<li>Elected Women Representatives</li>
							</ul>
							<br>
							<h4><b>Election Commission</b></h4>
							<p>A body similar to the Election Commission was formed as an independent constitutional authority to conduct elections to local bodies and municipalities. The Election Commission issues directions and instructions in the form of handbooks for the following:</p>
							<ul>
							...
							<p>For the office of president, Senator,governer and women representatives, the authority to enact laws remains with the Constitution in the Parliament. For the municipalities, panchayats and other local bodies, laws relating to the conduct of elections will be framed by the respective State Legislatures.</p>
						</div>
